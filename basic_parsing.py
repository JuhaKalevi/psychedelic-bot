...
async def fix_image_generation_prompt(message:str) -> str:
...
async def generate_text_from_message(message:str, model='gpt-4') -> str:
...
async def is_asking_for_multiple_images(message:str) -> bool:
...
def should_always_reply_on_channel(channel_purpose:str, bot_name:str) -> bool:
