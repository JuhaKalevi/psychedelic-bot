...
async def react(full_context:list, available_functions:dict):
  ...
  zero_shot_classifications_object = pipeline("zero-shot-classification", model="facebook/bart-large-mnli")(event_translation, event_categories.values(), multi_label=True)
