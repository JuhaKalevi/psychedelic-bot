...
async def chat_completion_choices(msgs:list, f_avail:dict, f_choose:list, choice:str, model:str):
  ...
  delta = ''
  print(f"messages={msgs}, functions={f_choose+f_coarse}, function_call={f_choose[0]['name']}, model={model}")
...
async def chat_completion_functions(msgs:list, f_avail:dict):
  ...
  f_required_context = await chat_completion_choices(msgs[-1:], {}, f_estimate_required_context, 'estimate_required_context', 'gpt-4-1106-preview')
