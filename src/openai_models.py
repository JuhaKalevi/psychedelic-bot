...
EVENT_CATEGORIES = ['Instructions given to the chatbot to perform a specific action.', 'Inquiries seeking information or explanations on a variety of topics.', 'Messages that address the chatbot directly or discuss its']
